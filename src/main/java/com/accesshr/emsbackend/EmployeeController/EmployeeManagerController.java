...
@CrossOrigin(origins = {"http://localhost:5173","https://company-product-frontend.azurewebsites.net", "http://localhost:3000","https://talents-flow-live-server.azurewebsites.net"}) // Adjust as needed for your frontend
